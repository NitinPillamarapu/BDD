...
test.describe('Login functionality', () => {
  ...
  test('User logs in with multiple credentials', async ({ Given, page }) => { 
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":30,"pickleLine":22,"tags":[],"steps":[{"pwStepLine":7,"gherkinStepLine":4,"keywordType":"Context","textWithKeyword":"Given I navigate to the login page","isBg":true,"stepMatchArguments":[]},{"pwStepLine":31,"gherkinStepLine":23,"keywordType":"Context","textWithKeyword":"Given The user logs in with the following credentials:","stepMatchArguments":[]}]},
]; // bdd-data-end